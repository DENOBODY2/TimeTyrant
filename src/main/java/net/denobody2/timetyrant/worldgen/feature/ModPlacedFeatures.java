...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> DEEPSLATE_TIME_SHARD_ORE_PLACED_KEY = registerKey("deepslate_time_shard_ore_placed");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(TimeTyrant.MOD_ID, name));
    }
